...
public abstract class HttpClient extends TransportClient<HttpClient, HttpClientConfig> {
	...
	public final WebsocketSender websocket(String subprotocols, int maxFramePayloadLength, boolean proxyPing) {
		...
		if (subprotocols.equals(configuration().websocketSubprotocols) &&
				maxFramePayloadLength == configuration().websocketMaxFramePayloadLength &&
				proxyPing == configuration().websocketProxyPing) {
			return (WebsocketFinalizer) this;
		}
